...
import net.sn0wix_.villagePillageArise.block.entities.ModHangingSignBlockEntity;
...
public class ModHangingSignBlockEntityRenderer extends ModSignBlockEntityRenderer<ModHangingSignBlockEntity> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(VillagePillageAriseMain.MOD_ID, "hanging_sign/azalea"), "main");
