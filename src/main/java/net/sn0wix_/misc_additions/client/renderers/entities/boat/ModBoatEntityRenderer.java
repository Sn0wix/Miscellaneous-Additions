...
public class ModBoatEntityRenderer extends EntityRenderer<ModBoatEntity> {
    private static final Identifier AZALEA_BOAT_LOCATION = new Identifier(MiscAdditions.MOD_ID,"textures/entity/boat/azalea.png");
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(MiscAdditions.MOD_ID, "boat/azalea"), "main");
