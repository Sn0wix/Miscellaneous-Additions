package net.sn0wix_.villagePillageArise.common.block;
...
import net.sn0wix_.villagePillageArise.common.block.custom.*;
import net.sn0wix_.villagePillageArise.common.sounds.ModSoundEvents;
import net.sn0wix_.villagePillageArise.common.util.ModBlockSetTypes;
...
public class ModBlocks {
    ...
    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, new Identifier(VillagePillageAriseMain.MOD_ID, name), new BlockItem(block, new FabricItemSettings()));
    }
