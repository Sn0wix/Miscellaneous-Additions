...
public class CitrineClusterBlock extends CitrineBlock implements Waterloggable {
    ...
    public CitrineClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
        super(settings);
