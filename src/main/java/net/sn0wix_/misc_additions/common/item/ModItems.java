...
import net.sn0wix_.misc_additions.common.item.custom.*;
import net.minecraft.util.Identifier;
import net.sn0wix_.misc_additions.common.item.custom.redstone.*;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(MiscAdditions.MOD_ID, name), item);
    }

    private static Item registerMusicDisc(String name, Item item) {
        Item item1 = Registry.register(Registries.ITEM, new Identifier(MiscAdditions.MOD_ID, name), item);
    ...
    public static void registerModItems() {
        MiscAdditions.LOGGER.info("Registering Mod items for " + MiscAdditions.MOD_ID);
    }
}
