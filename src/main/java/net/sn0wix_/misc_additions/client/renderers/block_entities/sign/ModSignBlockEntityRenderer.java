package net.sn0wix_.misc_additions.client.renderers.block_entities.sign;
...
public class ModSignBlockEntityRenderer<T extends ModSignBlockEntity> implements BlockEntityRenderer<T> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(MiscAdditions.MOD_ID, "sign/azalea"), "main");
    ...
    SpriteIdentifier getTextureId(WoodType signType) {
        return new SpriteIdentifier(TexturedRenderLayers.SIGNS_ATLAS_TEXTURE, new Identifier(MiscAdditions.MOD_ID,"entity/signs/azalea"));
    }
