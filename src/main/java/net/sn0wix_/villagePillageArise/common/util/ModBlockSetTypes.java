package net.sn0wix_.villagePillageArise.common.util;
...
public record ModBlockSetTypes() {
    public static final BlockSetType AZALEA = new BlockSetTypeBuilder().register(new Identifier(VillagePillageAriseMain.MOD_ID, "azalea"));
    ...
    public static final BlockSetType COPPER = new BlockSetTypeBuilder()
        ...
        .register(new Identifier(VillagePillageAriseMain.MOD_ID, "copper"));
}
