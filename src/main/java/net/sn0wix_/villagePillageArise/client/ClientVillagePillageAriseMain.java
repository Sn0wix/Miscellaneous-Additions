package net.sn0wix_.villagePillageArise.client;
...
import net.sn0wix_.villagePillageArise.client.renderers.entities.boat.ModBoatEntityRenderer;
import net.sn0wix_.villagePillageArise.client.renderers.entities.boat.ModChestBoatEntityRenderer;
import net.sn0wix_.villagePillageArise.common.networking.ModPackets;
import net.sn0wix_.villagePillageArise.common.util.ModModelPredicateProvider;
