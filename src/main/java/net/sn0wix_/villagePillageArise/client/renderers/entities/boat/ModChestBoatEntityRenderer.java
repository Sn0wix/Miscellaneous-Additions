package net.sn0wix_.villagePillageArise.client.renderers.entities.boat;
...
public class ModChestBoatEntityRenderer extends EntityRenderer<ModChestBoatEntity> {
    private static final Identifier AZALEA_CHEST_BOAT_LOCATION = new Identifier(VillagePillageAriseMain.MOD_ID,"textures/entity/chest_boat/azalea.png");
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(VillagePillageAriseMain.MOD_ID, "chest_boat/azalea"), "main");
